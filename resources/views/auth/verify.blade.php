        ...
        <form class="col s12"  method="POST" action="{{ route('verify') }}">
          ...
          <div class="row">
            <div class="input-field col s12">
              ...
              @if ($errors->has('email'))
                  <span class="new red badge left">{{ $errors->old('email') }}</span>
              @endif
            </div>
          </div>
          ...
          <div class="row">
            <div class="input-field col s12">
              ...
              @if ($errors->has('password'))
                  <span class="new red badge left">{{ $errors->old('password') }}</span>
              @endif
            </div>
          </div>
          ...
          <button type="submit" class="btn right waves-effect waves-light blue"><i class="material-icons right">send</i> Verify my email</button>
        </form>
      </div>
    </div>
</div>
